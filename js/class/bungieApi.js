export class BungieApi {
    ...
    async getInventoryManifest() {
        try {
            ...
            const url = "https://www.bungie.net/common/destiny2_content/json/fr/DestinyInventoryItemDefinition-699e2c05-aa2d-49fd-9688-50c2855af01a.json" //`https://www.bungie.net/common/destiny2_content/json/fr/DestinyInventoryItemDefinition-1b303207-5a14-4260-afb1-591ae61e113f.json`
            const res = await fetch(url, options)
